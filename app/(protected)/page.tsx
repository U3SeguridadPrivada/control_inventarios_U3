...
export default function DashboardPage() {
  ...
  const metricCards = [
    { title: "Total Entradas", value: metrics?.totalEntradas ?? 0, icon: ArrowDownToLine, color: "text-blue-600", bg: "bg-blue-50" },
    { title: "Total Salidas", value: metrics?.totalSalidas ?? 0, icon: ArrowUpFromLine, color: "text-orange-600", bg: "bg-orange-50" },
    { title: "Items en Campo", value: metrics?.itemsEnCampo ?? 0, icon: Package, color: "text-emerald-600", bg: "bg-emerald-50" },
    { title: "Guardias Activos", value: metrics?.guardiasActivos ?? 0, icon: Users, color: "text-violet-600", bg: "bg-violet-50" },
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {isEditor && (
          <div className="flex items-center gap-2">
            <Link href="/entradas"><Button size="sm"><ArrowDownToLine className="w-4 h-4 mr-1.5" /> Nueva Entrada</Button></Link>
            <Link href="/salidas"><Button size="sm" className="bg-accent hover:bg-accent/90 text-white"><ArrowUpFromLine className="w-4 h-4 mr-1.5" /> Nueva Salida</Button></Link>
            <Link href="/uniformes-campo"><Button size="sm" variant="outline"><ShieldCheck className="w-4 h-4 mr-1.5" /> En Campo</Button></Link>
          </div>
        )}
      </div>
