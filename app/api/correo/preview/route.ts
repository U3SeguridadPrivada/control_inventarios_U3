...
import { plantillaCorreo, firmaHtml, firmaDatosDe } from '@/src/lib/mailer';
...
// como vista previa en el compositor. Usa la MISMA plantilla que el envío real
// (mailer.ts) para que lo que se ve sea exactamente lo que llega; solo cambia el
// logo a la ruta pública /LOGO_PDFS.png porque el navegador no resuelve cid:.
export async function POST(req: NextRequest) {
  ...
  const html = plantillaCorreo(cuerpoHtml, firma, '/LOGO_PDFS.png');
